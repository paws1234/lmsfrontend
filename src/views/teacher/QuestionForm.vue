<template>
    <div class="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <!-- Question Form -->
        <div v-for="(question, questionIndex) in questions" :key="questionIndex" class="border border-gray-300 p-6 rounded-lg shadow-sm bg-gray-50">
          ...
          <div v-for="(answer, answerIndex) in question.answers" :key="answerIndex" class="flex items-center space-x-2 mb-4">
            <input
  ...
  export default {
    ...
    methods: {
      ...
      async submitForm() {
        try {
          // Send form topic and questions data to backend
          await axios.post('/teacher/questions', { form_topic: this.form_topic, questions: this.questions });
